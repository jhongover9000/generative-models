...
Original file is located at
    https://colab.research.google.com/drive/1JOW2WyH3rhuxIjY9Od26M2NPEWZW1X-M
...
outpath = "/scratch/jhh508/directed-study/finalProject/"

#@markdown `images_path` is a path to directory containing the training images. It could 
images_path = outpath + "Profile-Creator-Images/" #@param {type:"string"}
while not os.path.exists(str(images_path)):
  ...
  images_path=input("/content/gdrive/My Drive/Directed-Study/Directed-Study/Profile-Creator-Images/")
...
os.mkdirs(os.path.join(outpath, "sd-concept-output"), exist_ok = True)
...
name_of_your_concept = "Unique Face" #@param {type:"string"}
...
promptStart = "A portrait photo of the "
promptEnd = " version of \u003Cunique-face>, realistic, telephoto, 4K"

promptStarters = ["African", "Arab", "East Asian", "South Asian", "European", "Latino", "North American"]

num_samples = 3 #@param {type:"number"}
num_rows = 1 #@param {type:"number"}

all_images = [] 
for _ in range(promptStarters.count):
    prompt = promptStart + promptStarters[_] + promptEnd
    images = pipe([prompt] * num_samples, num_inference_steps=30, guidance_scale=7.5).images
    all_images.extend(images)

for i in range(all_images.count):
    all_images[i].save(os.path.join(outpath, f"{i}.png"))
