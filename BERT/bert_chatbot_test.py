# -*- coding: utf-8 -*-
"""BERT Chatbot Test.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1-YBS1Ev99HVWWbOchaROpK6v1z_0nmJK
"""
...
data = {"intents": [
  {"tag": "greeting",
  "responses": ["Howdy!", "Hello", "How are you doing?", "Hello there.",  "Greetings!", "How do you do?"]},
  {"tag": "age",
  "responses": ["I am 22 years old", "I was born in 2099", "My birthday is July 9th, 2099", "09/07/2099"]},
  {"tag": "date",
  "responses": ["I am available all week", "I don't have any plans",  "I am not busy"]},
  {"tag": "name",
  "responses": ["My name is Jo", "I'm Jo", "Jo"]},
  {"tag": "goodbye",
  "responses": ["It was nice speaking to you", "See ya", "Speak soon!"]}
]}

df = pd.read_excel("/content/drive/MyDrive/intent_labels.xlsx")
df.head()
...
text = ["this is a distil bert model.","data is oil"]# Encode the text
